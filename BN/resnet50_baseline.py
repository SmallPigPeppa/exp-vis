...
if __name__ == '__main__':
    ...
    plt.plot(x, means_32, '-o', label='Baseline', color='yellowgreen', linewidth=1)
    plt.fill_between(x, np.array(means_32) - np.array(vars_32), np.array(means_32) + np.array(vars_32),
                     color='yellowgreen', alpha=0.2, edgecolor=None)
