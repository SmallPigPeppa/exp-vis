...
if __name__ == '__main__':
    ...
    model_32 = load_weight_32(args.ckpt_path)
    model_32.train()

    model_128 = load_weight_128(args.ckpt_path)
    model_128.train()



    visualization = get_grad_vis(input_tensor,model)
    visualization_32 = get_grad_vis(input_tensor_32,model_32)
    visualization_128 = get_grad_vis(input_tensor_128,model_128)
