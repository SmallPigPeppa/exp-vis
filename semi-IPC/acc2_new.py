...
if __name__ == '__main__':
    ...
    def plot_dataset(ax, num_tasks, num_categories):
        ...
        n = re.match(r'\d+', num_tasks)
        ax.set_title(f'{dataset_name}', fontsize=fontsize0, loc="left")
        ax.set_title(f'T={n.group()}', fontsize=fontsize0, loc="right")
        ax.grid(True)
    ...
    fig.savefig(f'{config_file.split(".")[0]}.pdf',)
    plt.show()
