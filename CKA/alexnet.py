...
msc_2 = [
    [0.82011944, 0.8508089, 0.886014, 0.8784154, 0.8416607], [0.8047994, 0.7599789, 0.84423983, 0.8678523, 0.82815284],
    [0.8561844, 0.8296449, 0.8765189, 0.88894117, 0.8636553],
    [0.77911097, 0.80578405, 0.87111074, 0.8516849, 0.84498435],
    [0.80051935, 0.73673224, 0.8547491, 0.85146254, 0.7983864],
    [0.85408556, 0.80908877, 0.87324643, 0.8692337, 0.83295906],
    [0.804858, 0.8234354, 0.86122966, 0.86109525, 0.8502738],
    [0.86517733, 0.7956059, 0.86441016, 0.8662704, 0.84079516],
    [0.88372713, 0.8642472, 0.87372434, 0.85428214, 0.8492352],
    [0.84820896, 0.81378025, 0.86290526, 0.8562667, 0.84748405]
]
...
baseline = [[0.8132933, 0.8339945, 0.79128015, 0.7417278, 0.5889976],
            [0.7380045, 0.75065976, 0.77508086, 0.70105505, 0.58070755],
            [0.76611227, 0.7369388, 0.7205899, 0.64089125, 0.5112965],
            [0.80291593, 0.8304129, 0.8037415, 0.7443132, 0.58470976],
            [0.7832971, 0.7835797, 0.76078093, 0.6710489, 0.56538045],
            [0.7933682, 0.8115096, 0.78808147, 0.72845215, 0.56775486],
            [0.75260293, 0.8004905, 0.77025867, 0.69316363, 0.56628966],
            [0.781247, 0.79044724, 0.75557584, 0.6872334, 0.53294],
            [0.81274927, 0.81997764, 0.761213, 0.69329834, 0.54757285],
            [0.7613188, 0.81386435, 0.802813, 0.7287914, 0.5888677]]
# 将数据转换为NumPy数组
...
plt.savefig('result/alexnet.pdf', format='pdf', bbox_inches='tight')
plt.show()
