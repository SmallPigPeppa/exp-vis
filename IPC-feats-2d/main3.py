...
if __name__=="__main__":
    ...
    for i in [0,2,8,9]:
        ...
        ax.scatter(new_data_2d[num*i:num*(i+1), 0], new_data_2d[num*i:num*(i+1), 1], marker='o', label=f'New Class {i}')
        ...
        # ax.scatter(new_data_2d[num*2:num*3, 0], new_data_2d[num:, 1], marker='o', label='New Class 2')
