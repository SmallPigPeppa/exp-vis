...
if __name__ == '__main__':
    ...
    ax1.set_title('CIFAR-10', loc="left")
    ...
    ax2.set_ylabel("Normalized Eigenvalues", fontsize=16)
    ...
    fig.savefig('PC-ID-curve-all-style2.pdf', bbox_extra_artists=(legend,), bbox_inches='tight')
    plt.show()
