...
if __name__ == '__main__':
    ...
    ax1.set_title('CIFAR-100', loc="left",fontsize=fontsize0)
    ...
    ax2.set_title('CIFAR-100', loc="left",fontsize=14)
    ...
    #                        bbox_to_anchor=(0.5, 1.4), ncol=4, columnspacing=1.0, fontsize=fontsize0)

    ax1.set_xticks(list(range(0, components, 2)))
    ax2.set_xticks(list(range(0, components, 2)))

    plt.tight_layout()
    plt.savefig(f'PC-ID-curve-log-error-bar-cifar100-new-new.pdf')
    # fig.savefig('PC-ID-curve-log-error-bar-cifar100-new.pdf', bbox_extra_artists=(legend,), bbox_inches='tight')
    plt.show()
