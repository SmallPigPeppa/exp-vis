...
# from resnet18_cifar_reparam_1x3 import resnet18
from resnet18_cifar_reparam import resnet18
import torch
...
def laod_args():
    ...
    parser.add_argument('--ckpt_path', type=str, default='ckpt/byol-ft-task4.ckpt', help='')
    parser.add_argument('--data_dir', type=str, default='./data', help='')
    parser.add_argument('--method_name', type=str, default='byol-ft-task4', help='')
...
def load_weight(ckpt_path):
    ...
    encoder.set_branchs(use_branch=False)
    return encoder
...
if __name__ == '__main__':
    ...
    np.save(os.path.join(args.save_dir, f'{args.method_name}_features.npy'), sorted_features[:10000])
    np.save(os.path.join(args.save_dir, f'{args.method_name}_labels.npy'), sorted_labels[:10000])
